...
<Warning>
  Every MCP server will pass an audit process to ensure it is secure and does not contain any malicious code. If your
  MCP server does not pass the audit process, it will still be published but exposed as unsafe.
